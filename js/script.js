function privscope(){
  ...
  */
  ...
  function setup(logindata){
    document.getElementById("settingsUi").onclick = () => {
  ...
  function closelog(){
      ...
      document.getElementById("logshow").style.visibility = "visible";
      document.getElementById("settingsUi").style.visibility = "visible";
      minx = 0;
  }
